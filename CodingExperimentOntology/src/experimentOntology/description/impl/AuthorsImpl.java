 ...
 * </p>
 * <ul>
 *   <li>{@link experimentOntology.description.impl.AuthorsImpl#getAuthor <em>Author</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AuthorsImpl extends MinimalEObjectImpl.Container implements Authors {
	...
	protected EClass eStaticClass() {
		return DescriptionPackage.Literals.AUTHORS;
	}
	...
	public EList<Author> getAuthor() {
		if (author == null) {
			author = new EObjectContainmentEList<Author>(Author.class, this, DescriptionPackage.AUTHORS__AUTHOR);
		}
		return author;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DescriptionPackage.AUTHORS__AUTHOR:
