 ...
 * </p>
 * <ul>
 *   <li>{@link experimentOntology.description.gqm.impl.MetricsImpl#getMetric <em>Metric</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MetricsImpl extends MinimalEObjectImpl.Container implements Metrics {
	 ...
	 * @ordered
	 */
	protected EList<MetricGQM> metric;
	...
	protected EClass eStaticClass() {
		return GqmPackage.Literals.METRICS;
	}
	 ...
	 * @generated
	 */
	public EList<MetricGQM> getMetric() {
		if (metric == null) {
			metric = new EObjectContainmentEList<MetricGQM>(MetricGQM.class, this, GqmPackage.METRICS__METRIC);
		}
		return metric;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case GqmPackage.METRICS__METRIC:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case GqmPackage.METRICS__METRIC:
				getMetric().clear();
				getMetric().addAll((Collection<? extends MetricGQM>)newValue);
				return;
		}
