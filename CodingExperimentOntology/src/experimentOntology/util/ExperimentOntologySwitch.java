 ...
 * @generated
 */
public class ExperimentOntologySwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public ExperimentOntologySwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ExperimentOntologyPackage.EXPERIMENTAL_STUDY: {
				ExperimentalStudy experimentalStudy = (ExperimentalStudy)theEObject;
				T result = caseExperimentalStudy(experimentalStudy);
			...
			case ExperimentOntologyPackage.REPLICATION: {
				Replication replication = (Replication)theEObject;
				T result = caseReplication(replication);
				if (result == null) result = caseExperiment(replication);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
