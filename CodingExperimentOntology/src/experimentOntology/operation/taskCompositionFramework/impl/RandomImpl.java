 ...
 * </p>
 * <ul>
 *   <li>{@link experimentOntology.operation.taskCompositionFramework.impl.RandomImpl#getTask <em>Task</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RandomImpl extends TaskImpl implements Random {
	/**
	...
	protected EClass eStaticClass() {
		return TaskCompositionFrameworkPackage.Literals.RANDOM;
	}
	...
	public EList<Task> getTask() {
		if (task == null) {
			task = new EObjectContainmentEList<Task>(Task.class, this, TaskCompositionFrameworkPackage.RANDOM__TASK);
		}
		return task;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TaskCompositionFrameworkPackage.RANDOM__TASK:
