...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Questionary By Task</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link codingExperimentOntology.apparatus.impl.QuestionaryByTaskImpl#getQuestions <em>Questions</em>}</li>
 *   <li>{@link codingExperimentOntology.apparatus.impl.QuestionaryByTaskImpl#getAllocation <em>Allocation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class QuestionaryByTaskImpl extends TaskRelatedImpl implements QuestionaryByTask {
	/**
	 ...
	 * @generated
	 */
	protected QuestionaryByTaskImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return NewPackage4Package.Literals.QUESTIONARY_BY_TASK;
	}
	...
	public EList<Question> getQuestions() {
		if (questions == null) {
			questions = new EObjectContainmentEList<Question>(Question.class, this, NewPackage4Package.QUESTIONARY_BY_TASK__QUESTIONS);
		}
		return questions;
	}
	...
	public void setAllocation(QuestionnarieAllocation newAllocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NewPackage4Package.QUESTIONARY_BY_TASK__ALLOCATION, oldAllocation, allocation));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case NewPackage4Package.QUESTIONARY_BY_TASK__QUESTIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case NewPackage4Package.QUESTIONARY_BY_TASK__QUESTIONS:
				return getQuestions();
			case NewPackage4Package.QUESTIONARY_BY_TASK__ALLOCATION:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == Questionnaire.class) {
			switch (derivedFeatureID) {
				case NewPackage4Package.QUESTIONARY_BY_TASK__QUESTIONS: return NewPackage4Package.QUESTIONNAIRE__QUESTIONS;
				case NewPackage4Package.QUESTIONARY_BY_TASK__ALLOCATION: return NewPackage4Package.QUESTIONNAIRE__ALLOCATION;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == Questionnaire.class) {
			switch (baseFeatureID) {
				case NewPackage4Package.QUESTIONNAIRE__QUESTIONS: return NewPackage4Package.QUESTIONARY_BY_TASK__QUESTIONS;
				case NewPackage4Package.QUESTIONNAIRE__ALLOCATION: return NewPackage4Package.QUESTIONARY_BY_TASK__ALLOCATION;
				default: return -1;
			}
		}
