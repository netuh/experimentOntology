...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Conventional Coding Task</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link codingExperimentOntology.tasks.impl.ConventionalCodingTaskImpl#getTaskType <em>Task Type</em>}</li>
 *   <li>{@link codingExperimentOntology.tasks.impl.ConventionalCodingTaskImpl#getRequiredArtifact <em>Required Artifact</em>}</li>
 *   <li>{@link codingExperimentOntology.tasks.impl.ConventionalCodingTaskImpl#getProducedArtifact <em>Produced Artifact</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ConventionalCodingTaskImpl extends MinimalEObjectImpl.Container implements ConventionalCodingTask {
	/**
	 ...
	 * @generated
	 */
	protected ConventionalCodingTaskImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return NewPackage2Package.Literals.CONVENTIONAL_CODING_TASK;
	}
	...
	public void setTaskType(CodingTaskTypes newTaskType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NewPackage2Package.CONVENTIONAL_CODING_TASK__TASK_TYPE, oldTaskType, taskType));
	}
	...
	public EList<CodingArtifact> getRequiredArtifact() {
		if (requiredArtifact == null) {
			requiredArtifact = new EObjectResolvingEList<CodingArtifact>(CodingArtifact.class, this, NewPackage2Package.CONVENTIONAL_CODING_TASK__REQUIRED_ARTIFACT);
		}
	...
	public EList<CodingArtifact> getProducedArtifact() {
		if (producedArtifact == null) {
			producedArtifact = new EObjectResolvingEList<CodingArtifact>(CodingArtifact.class, this, NewPackage2Package.CONVENTIONAL_CODING_TASK__PRODUCED_ARTIFACT);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case NewPackage2Package.CONVENTIONAL_CODING_TASK__TASK_TYPE:
				return getTaskType();
			case NewPackage2Package.CONVENTIONAL_CODING_TASK__REQUIRED_ARTIFACT:
				return getRequiredArtifact();
			case NewPackage2Package.CONVENTIONAL_CODING_TASK__PRODUCED_ARTIFACT:
